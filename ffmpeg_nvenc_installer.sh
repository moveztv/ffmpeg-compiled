...
#    echo "---- Installing yum nvidia-driver"
#    yum install nvidia-driver-cuda nvidia-driver
    echo "---- Installing cuda${CUDA_RPM_VER}"
    yum install -y "cuda${CUDA_RPM_VER}"
    echo "---- cuda${CUDA_RPM_VER} installed!"
}
